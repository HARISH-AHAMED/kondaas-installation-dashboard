                            ...
                            <div className="flex gap-[0.8vw] w-full shrink-0">
                                {['residential', 'commercial', 'waterHeater'].map(type => (
                                    <button 
                                        ...
                                        className={`flex-1 py-[1.2vh] rounded-[1.5vh] text-[1.4vh] font-black uppercase tracking-wider transition-all shadow-sm border ${activeTab === type ? 'bg-brand-red text-white border-brand-red shadow-lg' : 'bg-white text-slate-500 border-slate-100 hover:bg-slate-50 shadow-[0_0_15px_rgba(0,0,0,0.04)]'}`}
                                    >
                            ...
                            <div className="bg-white p-[2vh] rounded-[2vh] shadow-[0_0_20px_rgba(0,0,0,0.05)] flex-1 flex flex-col justify-start gap-[1.5vh] border border-slate-100 relative overflow-hidden">
                                <div>
                                    <div className="flex justify-between items-center mb-[1vh]">
                                        ...
                                        <span className="bg-brand-red/10 text-brand-red font-black text-[0.9vh] px-[0.8vh] py-[0.3vh] rounded-full uppercase tracking-widest border border-brand-red/20 shrink-0">
                                ...
                                <div className="absolute bottom-[2vh] right-[2vh] flex gap-[0.4vw]">
                                    {REVIEWS.map((_, i) => (
                                        <div key={i} className={`h-[0.5vh] rounded-full transition-all duration-300 ${i === activeReview ? 'w-[1.2vw] bg-brand-red' : 'w-[0.7vh] bg-slate-200'}`}></div>
                                    ))}
                                </div>
                            </div>
                        </div>
